defmodule Assent.Test.OAuth2TestCase do
  ...
  setup _tags do
    ...
    config = [client_id: "id", client_secret: "secret", site: TestServer.url(), redirect_uri: "http://localhost:4000/auth/callback", session_params: %{state: "state_test_value", code_verifier: nil}]
